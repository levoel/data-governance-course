...
Это завершает модуль **M03: Метаданные и Каталоги Данных**. Вы изучили: типы метаданных, бизнес-глоссарий, архитектуру каталога, Data Lineage, стандарты метаданных и автоматическую классификацию. В следующем модуле мы перейдём к **M04: Качество Данных и Observability**.
