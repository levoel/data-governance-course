...
<DecisionMatrix
  ...
  criteria={[
    { name: "Сложность внедрения", weight: 0.20, description: "Объём работ и ресурсы для запуска" },
    { name: "Качество данных", weight: 0.27, description: "Насколько паттерн улучшает DQ" },
    { name: "Инвазивность", weight: 0.20, description: "Изменения в существующих системах" },
    { name: "Единая версия правды", weight: 0.33, description: "Гарантия единого golden record" }
  ]}
  options={[
    {
      name: "Registry",
