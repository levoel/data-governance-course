...
<MaturityModel
  ...
  levels={[
    { name: "Ad-hoc", description: "Дубликаты накапливаются, нет процесса дедупликации. 15%+ дубликатов, нет golden record" },
    { name: "Reactive", description: "Периодическая дедупликация, ручные процессы. Registry паттерн, ежеквартальная очистка" },
    { name: "Proactive", description: "Автоматический matching, Consolidation/Coexistence. Survivorship rules определены" },
    { name: "Managed", description: "MDM-хаб интегрирован со всеми системами. SLA на golden record freshness" },
    { name: "Optimized", description: "MDM как платформа, self-service, continuous improvement. ML-driven survivorship" }
  ]}
/>
