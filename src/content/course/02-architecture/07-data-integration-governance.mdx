...
<DecisionMatrix
  ...
  criteria={[
    { name: "Добавление опционального поля", weight: 2 },
    { name: "Удаление поля", weight: 3 },
    { name: "Изменение типа поля", weight: 3 },
    { name: "Добавление required поля", weight: 2 },
    { name: "Гибкость producer", weight: 1 },
    { name: "Защита consumer", weight: 3 }
  ]}
  options={[
...
<DecisionMatrix
  ...
  criteria={[
    { name: "Ownership complexity", weight: 3 },
    { name: "Latency requirements", weight: 2 },
    { name: "Testing difficulty", weight: 2 },
    { name: "Rollback capability", weight: 3 },
    { name: "Schema governance", weight: 2 },
    { name: "Monitoring maturity needed", weight: 1 }
  ]}
  options={[
...
- **Streaming CDC** (Debezium, Kafka): сложный ownership (topic = producer + N consumers), трудный rollback, но near-realtime. Требует Level 3+ governance. Подробнее -- в [курсе Debezium](/debezium/06-etl-elt-patterns/).
