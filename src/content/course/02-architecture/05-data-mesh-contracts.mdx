...
<DecisionMatrix
  ...
  criteria={[
    { name: "Масштаб организации (500+ сотрудников)", weight: 0.27 },
    { name: "Количество доменов данных (5+)", weight: 0.18 },
    { name: "Governance-зрелость (Level 3+)", weight: 0.27 },
    { name: "Готовность доменных команд", weight: 0.18 },
    { name: "Инвестиции в платформу", weight: 0.09 }
  ]}
  options={[
