...
> ```
>
> Open JupyterLab at [http://localhost:28888](http://localhost:28888) and complete **Notebooks 02 and 03: Expectation Basics + Expectation Suite** -- write GE expectations against dirty data, build a full suite, and run a validation checkpoint.
>
